...
var react_motion_1 = __webpack_require__(4);
var ensureSpring_1 = __webpack_require__(19);
var RouteTransition = (function (_super) {
    __extends(RouteTransition, _super);
    function RouteTransition() {
        var _this = this;
        _super.apply(this, arguments);
        this.getDefaultStyles = function () {
            if (!_this.props.runOnMount) {
                return null;
            }
            ...
            return [{
                    key: _this.props.pathname,
                    data: _this.props.children,
                    style: _this.props.atEnter
                }];
        };
        this.getStyles = function () {
            ...
            return [{
                    key: _this.props.pathname,
                    data: _this.props.children,
                    style: ensureSpring_1["default"](_this.props.atActive)
                }];
        };
        ...
        this.willLeave = function () {
            return ensureSpring_1["default"](_this.props.atLeave);
        };
        this.renderRoute = function (config) {
            var props = {
                style: _this.props.mapStyles(config.style),
                key: config.key
            };
            return _this.props.component
                ? React.createElement(_this.props.component, props, config.data)
                : React.cloneElement(config.data, props);
        };
        this.renderRoutes = function (interpolatedStyles) {
            return (React.createElement("div", {className: _this.props.className, style: _this.props.style}, interpolatedStyles.map(_this.renderRoute)));
        };
    }
    RouteTransition.prototype.render = function () {
        return (React.createElement(react_motion_1.TransitionMotion, {defaultStyles: this.getDefaultStyles(), styles: this.getStyles(), willEnter: this.willEnter, willLeave: this.willLeave}, this.renderRoutes));
    };
    RouteTransition.defaultProps = {
        ...
        component: 'div',
        runOnMount: true,
        mapStyles: function (val) { return val; }
    };
...
var fade = {
    ...
    atLeave: {
        opacity: react_motion_1.spring(0, fadeConfig)
    },
    atActive: {
        opacity: react_motion_1.spring(1, fadeConfig)
    }
};
var pop = {
    atEnter: {
    ...
    atLeave: {
        scale: react_motion_1.spring(0.8, popConfig),
        opacity: react_motion_1.spring(0, popConfig)
    },
    atActive: {
        scale: react_motion_1.spring(1, popConfig),
        opacity: 1
    },
...
var slideLeft = {
    ...
    atLeave: {
        opacity: react_motion_1.spring(0, fadeConfig),
        offset: react_motion_1.spring(-100, slideConfig)
    },
    atActive: {
        opacity: react_motion_1.spring(1, slideConfig),
        offset: react_motion_1.spring(0, slideConfig)
    },
    mapStyles: function (styles) {
        return {
            opacity: styles.opacity,
...
exports.__esModule = true;
exports["default"] = { fade: fade, pop: pop, slideLeft: slideLeft, slideRight: slideRight, slideUp: slideUp };
...
"use strict";
"use strict";
var RouteTransition_1 = __webpack_require__(10);
